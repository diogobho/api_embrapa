...
@app.route('/')
def index():
    return render_template('index.html', titulo='Embrapa - Vitivicultura')
...
def comercializacao():
    if request.method == 'POST':
        ...
        return render_template('comercializacao.html', table=df_html, user_year=user_year, titulo=' Embrapa - Comercialização')
    
    elif request.method == 'GET':
        return render_template('producao.html', table=None, titulo=' Embrapa - Comercialização')
